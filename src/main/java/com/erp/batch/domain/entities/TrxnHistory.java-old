...
@Entity(name = "TrxnHistory")
@TableName(value = "TrxnHistory")
public class TrxnHistory extends com.it.soul.lab.sql.entity.Entity {
    ...
    public TrxnHistory(@NotNull(message = "Name must not be null") String name
            , Gender sex
    ...
    public boolean equals(Object o) {
        ...
        TrxnHistory trxnHistory = (TrxnHistory) o;
        return Objects.equals(id, trxnHistory.id);
    }
