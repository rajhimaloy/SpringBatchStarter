...
import com.erp.batch.services.iServices.ContentWriter;
...
public class JDBCBatchWriter<E extends Entity> implements ContentWriter<E> {
    ...
    private static Logger LOG = Logger.getLogger(com.erp.batch.services.impl.JDBCBatchWriter.class.getSimpleName());
